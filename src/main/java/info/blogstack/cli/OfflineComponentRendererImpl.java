...
/**
 * Redefinición del servicio proporcionado por Tapestry Offline para que no haga la ejecución en
 * paralelo (para que se comparta la sesión de hibernate).
 */
public class OfflineComponentRendererImpl implements OfflineComponentRenderer {
	...
	public OfflineComponentRendererImpl(ComponentRequestHandler componentRequestHandler,
	...
	protected void doRender(final Response response,
